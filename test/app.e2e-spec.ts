...
describe('App (e2e)', () => {
  ...
  beforeAll(() => {
    ...
    process.env.PINECONE_ENVIRONMENT = process.env.PINECONE_ENVIRONMENT || 'gcp-starter';
  });
      ...
      .useValue({
        processMessage: jest.fn().mockResolvedValue({
          ...
          conversation: {
            ...
            variables: { name: undefined, birthDate: undefined, weightLossReason: undefined },
          },
        }),
    ...
    it('returns 201 and response shape when body is valid', () => {
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(res.body.conversation).toHaveProperty('phoneNumber', '5511999999999');
