...
describe("ConversationsService", () => {
  ...
  it("should process message successfully", async () => {
    ...
    jest
      .spyOn(conversationService, "createMessage")
  ...
  it("should throw error for expired conversation", async () => {
    ...
    jest
      .spyOn(conversationService, "findOrCreateConversation")
      .mockResolvedValue(expiredConversation);
  ...
  it("should throw error for finished conversation", async () => {
    ...
    jest
      .spyOn(conversationService, "findOrCreateConversation")
      .mockResolvedValue(qualifiedConversation);
  ...
  it("should get status", async () => {
    ...
    jest
      .spyOn(conversationService, "getConversationStatus")
